						...
						<div class="card-body">
							<div class="col-sm-6 col-lg-3">
								...
								<div class="col text-center">
									<button class="btn btn-primary btn-outline-primary btn-round" data-toggle="modal"
											data-target="#EventsModal"> Add Event
									</button>
								</div>
								<!-- Sart Modal -->
								<div class="modal fade" id="EventsModal" tabindex="-1" role="dialog"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<form class="form" method="POST" action="<?php echo base_url() ?>addEvent">
                                    ...
                                    <span class="input-group-text">
                                        <i class="now-ui-icons ui-1_lock-circle-open"></i>
														...
														<input type="text" class="form-control" placeholder="Event Name"
															   name="event_name" id="event_id" required>
													</div>
													<div class="input-group no-border">
														<div class="input-group-prepend">
                                      <span class="input-group-text">
                                        ...
                                        <span class="input-group-text">
                                          <i class="now-ui-icons ui-1_lock-circle-open"></i>
														...
														<input type="number" class="form-control"
															   placeholder="Number Of Attendees" name="attendees"
															   id="attendees" required>
													</div>
													<div class="input-group no-border">
														<div class="input-group-prepend">
                                          <span class="input-group-text">
                                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
														...
														<input type="number" class="form-control"
															   placeholder="VIP Ticket Price" name="ticket_vip"
															   id="ticket_vip" required>
													</div>
													<div class="input-group no-border">
														<div class="input-group-prepend">
                                            <span class="input-group-text">
                                              <i class="now-ui-icons ui-1_lock-circle-open"></i>
														...
														<input type="number" class="form-control"
															   placeholder="Regular Ticket Price" name="ticket_regular"
															   id="ticket_regular" required>
													</div>
													<div class="input-group no-border">
														<div class="input-group-prepend">
                                              <span class="input-group-text">
												...
												<div class="modal-footer">
													...
													<button type="button" class="btn btn-danger btn-round btn-lg"
