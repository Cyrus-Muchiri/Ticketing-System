...
<head>
	<meta charset="utf-8"/>
	<link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url(); ?>assets/img/apple-icon.jpg">
		...
		<nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
			<div class="container-fluid">
				<div class="navbar-wrapper">
					...
					<a class="navbar-brand" href="#">View,Edit & Delete Events</a>
				</div>
				...
				<table class="table">
					...
					foreach ($allEvents as $event) {
						...
						<tr>
							...
							<td><a href="<?php echo base_url()?>removeEvent/<?php echo $event->index_ID ?>">Delete Event</a> </td>
